package com.syarifme.viewslider.activity
...
import com.syarifme.viewslider.R
import com.syarifme.viewslider.adapter.MovieAdapter
import com.syarifme.viewslider.connection.ConnectionChecker
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val status : Boolean = ConnectionChecker.getInstance().isConnectionAlailabe(applicationContext)
